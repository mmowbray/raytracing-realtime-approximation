...
void cursor_pos_callback(GLFWwindow* window, double xpos, double ypos) {
    ...
    if (glfwGetMouseButton(window, GLFW_MOUSE_BUTTON_LEFT) == GLFW_PRESS)
    {
        if(ypos_old != -1)
        {
            ...
            model->getModelMatrix() = glm::rotate(model->getModelMatrix(), (float)(0.005 * (xpos_old - xpos)), glm::vec3(0.0, 1.0, 0.0));
            model->getModelMatrix() = glm::rotate(model->getModelMatrix(), (float)(0.005 * (ypos_old - ypos)), glm::vec3(1.0, 0.0, 0.0));
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        backShader->setUniform("model_matrix", model->getModelMatrix());
        ...
        frontShader->setUniform("model_matrix", model->getModelMatrix());
        ...
        frontShader->setUniform("draw_specular", false);
